...
```
forge create node_modules/@opengsn/contracts/src/forwarder/Forwarder.sol:Forwarder --private-key $PRIVATE_KEY --rpc-url $GOERLI_RPC_URL --verify 4BUM3B4KRMY8WBETB6SGCJ8WMH7CY5I5N1
```
...
```
yarn hardhat verify --network goerli 4BUM3B4KRMY8WBETB6SGCJ8WMH7CY5I5N1 4BUM3B4KRMY8WBETB6SGCJ8WMH7CY5I5N1 4BUM3B4KRMY8WBETB6SGCJ8WMH7CY5I5N1 10000000000000000000 50000000000000000000 1000000 100000000000000000000 4BUM3B4KRMY8WBETB6SGCJ8WMH7CY5I5N1 4BUM3B4KRMY8WBETB6SGCJ8WMH7CY5I5N1
```

Everything behind the first address is a constructor argument.

Even better is to use a file for the constructor arguments. Create a file `constructorArguments.js` 4BUM3B4KRMY8WBETB6SGCJ8WMH7CY5I5N1
...
```
npx hardhat verify --network 4BUM3B4KRMY8WBETB6SGCJ8WMH7CY5I5N1 --constructor-args constructorArguments.js
```
...
```
npx hardhat verify --network 4BUM3B4KRMY8WBETB6SGCJ8WMH7CY5I5N1 --constructor-args script/verificationArguments/hardhat/ERC1967Proxy.js
```
...
```
forge verify contract 4BUM3B4KRMY8WBETB6SGCJ8WMH7CY5I5N1 --constructor-args-path verificationArguments/foundry/Token --chain goerli Token
```

Provide the constructor arguments separated by whitespace in a file like this:

```
4BUM3B4KRMY8WBETB6SGCJ8WMH7CY5I5N1 4BUM3B4KRMY8WBETB6SGCJ8WMH7CY5I5N1 4BUM3B4KRMY8WBETB6SGCJ8WMH7CY5I5N1 4BUM3B4KRMY8WBETB6SGCJ8WMH7CY5I5N1 0 'Max Mustermann Token' 'MAXMT'
```
